...
public:
   ...
   * \note During the first _nbFrames frames creation,
   *   the returned fps value is wrong
   */
...
private:
  ...
  inline static std::array<double, _nbFrames> _lastFramesDuration;


  inline static bool _firstBurst;           ///< Initialization
  inline static double _computationTimeSum; ///< Cached sum
  inline static size_t _currentIndex;       ///< Frame array index
  inline static double _fps;                ///< FPS, on average
};
